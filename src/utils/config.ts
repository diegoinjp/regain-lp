...
export const Menu: ModalContentType[] = [
  {
    title: "About",
    content:
      "学生4人によって結成された映画製作団体「ST.Moonlight」の記念すべき第一作目いよいよ公開!! 彼女も友達も失った青年が、師匠との奇妙な関係を通して成長し、失くしたものを再び取り戻す物語",
  },
  {
    title: "Cast",
    content:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias at earum, unde dolor labore dolorem molestias debitis excepturi molestiae quis minima natus qui fugiat, voluptates hic facilis sed provident ipsa!",
  },
  {
    title: "Staff",
    content:
      "飛せけ打大ヌ載本ヲヨトロ載旧サルト審役をぜ思表ぴふおょ覇写ぐ際章をみフじ演枝ーフちぜ抱張ヲワノケ夜誠ゃら切6得冠みリぱ。実60関動ふね応議べ和43報どンるま護盛田紙ネ利聞メフ学諾タクロユ郎津ーまリれ摘4会旅ホヘ任徹ラわ問資ヨフオ座宿りドぼて証権太津え。動ひみぽ入品べラこ解木互ルスネモ岩教次ぞべっレ健食イタノメ勢真かゃ知意だぞド六芋ヨウラ芸報イ暮口キ無幅48身ル指飲ほう。",
  },
  {
    title: "Contact",
    content:
...
export const modalBg =
  "fixed w-full h-screen bg-black/50 grid place-items-center z-30 top-0 left-0";
