    ...
    <>
      {$isModalOpen && (
        <div class={modalBg} onClick={() => isModalOpen.set(false)}>
          <div
            class="bg-hotpink-white p-6 md:p-8 w-5/6 md:w-[30rem] text-gray-700 text-left flex flex-col gap-3 relative"
            onClick={(e) => e.stopPropagation()}
          >
            <h1 class="text-4xl uppercase font-semibold first-letter:text-hotpink-main">
              {$modalContent.title}
            </h1>
